...
export default function Hero() {
  ...
  useGSAP(
    () => {
      const headlineSplit = new SplitText('[data-hero-headline]', {
        type: 'lines,words',
        mask: 'lines',
      })
      const subSplit = new SplitText('[data-hero-sub]', {
        type: 'lines',
        mask: 'lines',
      })
  ...
  return (
    <section
      ref={containerRef}
      className="relative min-h-screen flex flex-col justify-center px-8 pt-24 pb-16 md:pt-32 md:pb-24 max-w-[1440px] mx-auto"
    >
      <h1
        data-hero-headline
      ...
      >
        Simple, professional websites built for businesses, services, and local
        shops. Quick, easy and hassle-free.
      </p>
