...
export const PROJECTS = [
  {
    ...
    description:
      'A two-in-one site for a Northern Ireland baker — a wedding cake portfolio with a custom enquiry form (including inspiration image uploads) and a workshops booking page for hen parties, baby showers, and team days.',
